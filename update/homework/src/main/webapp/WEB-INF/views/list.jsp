...
<tbody>
<c:forEach var="v2ListResponseVO" items="${homeListResponseVOList}">
<tr>
<td class="text-center"><!-- 글번호 -->
${homeListResponseVO.blgContSeq}
</td>
<td>
<a href="/read/${homeListResponseVO.blgContSeq}"><!-- 그순번에 맞는 글이 read -->
${homeListResponseVO.title}<!-- 제목 -->
</a>
</td>
...
${homeListResponseVO.insertDtFormat}
   ...
   <a href="${homework}/create" class="btn btn-outline-success">
   create
   </a>
   </div>
