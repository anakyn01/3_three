...
<tbody>
<c:forEach var="v2ListResponseVO" items="${v2ListResponseVOList}">
<tr>
<td class="text-center"><!-- 글번호 -->
${v2ListResponseVO.blgContSeq}
</td>
<td>
<a href="/read/${v2ListResponseVO.blgContSeq}"><!-- 그순번에 맞는 글이 read -->
${v2ListResponseVO.title}<!-- 제목 -->
</a>
</td>
<td class="text-center">
${v2ListResponseVO.insertDtFormat}
</td>
</tr>
</c:forEach>
</tbody>
	...
	<c:if test="${empty v2ListResponseVOList}">
